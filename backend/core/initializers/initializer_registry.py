...
class InitializerRegistry:
    ...
    def register_initializer_class(self, name: str, initializer_class: Type[BaseInitializer]) -> None:
        """
    ...
    def create_initializer(self, name: str, config: Optional[Dict[str, Any]] = None) -> BaseInitializer:
        """
        ...
        try:
            ...
            for batch_idx, batch in enumerate(batches):
                ...
                if failed_initializers:
                    raise ConfigurationError(
                        f"Failed to initialize: {failed_initializers}"
                    )
    ...
    def get_status_summary(self) -> Dict[str, Any]:
        ...
        for name, initializer in self._initializers.items():
            ...
            initializers_status[name] = {
                "status": status,
                "initialized_at": initializer.state.initialized_at.isoformat() if initializer.state.initialized_at else None,
