...
class CustomsPipelineService(BaseService):
    ...
    def __init__(
        self, name: str = "customs_pipeline_service", config: Optional[Dict[str, Any]] = None
    ):
    ...
    async def _call_pdf_parser_service(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await PDFParserService.parse_document_sync(
                file_url=context.get("file_url"), file_content=context.get("file_content")
            )
    ...
    def _generate_pipeline_report(
        self, pdf_result: Dict[str, Any], analysis_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "executive_summary": {
                ...
                "overall_status": (
                    "completed"
                    if pdf_result.get("success") and analysis_result.get("success")
                    else "failed"
                ),
            },
            "processing_details": {
                ...
                "llm_analysis": {
                    ...
                    "discrepancies_found": analysis_result.get("analysis_result", {}).get(
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                status["router_services"] = {"error": f"Router service import failed: {e}"}
