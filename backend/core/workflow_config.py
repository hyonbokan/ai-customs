    ...
    def get_development_config() -> Dict[str, Any]:
        ...
        for service in config_base["api_services"]:
            if service["name"] == "pdf_parser":
                ...
                service["config"]["analysis_timeout"] = dev_overrides.get("LLM_ANALYSIS_TIMEOUT", 60)
    ...
    def get_production_config() -> Dict[str, Any]:
        ...
        for service in config_base["api_services"]:
            if service["name"] == "pdf_parser":
                ...
                service["config"]["max_file_size_mb"] = prod_overrides.get("PDF_MAX_FILE_SIZE_MB", 100)
            elif service["name"] == "declaration_analyzer":
                service["config"]["confidence_threshold"] = prod_overrides.get("LLM_CONFIDENCE_THRESHOLD", 0.8)
